...
<form>
    ...
    <div class="form-group">
        ...
        <select type="text" id="loaiXeID" name="loaiXeID" cssClass="form-control"  class="select_form">
    ...
    <div class="form-group">
        ...
        <select type="text" id="nhaXeID" name="nhaXeID" cssClass="form-control" class="select_form">
    ...
    <div class="form-group" style="display: flex; align-items: center">
        ...
        <select type="text" id="tuyenXeID" name="tuyenXeID" cssClass="form-control" class="select_form">
    ...
    <div class="form-group">
        <label for="gioXeChay">Giờ xe chạy</label> 
        <input type="text" id="gioXeChay" name="gioXeChay" class="form-control" />
    </div>
    ...
    <div class="form-group">
        <div class="spinner-border mySpinnerThemCX" style="display: none"></div>
        <input onclick="handleThemChuyenXe(`${endpoint}`)" value="Thêm chuyến xe" class="btn btn-success btnThemCX" />
    </div>
</form>
