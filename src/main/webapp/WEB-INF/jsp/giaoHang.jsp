...
<c:if test="${listChuyenXe.size() > 0}">
    <p class="text-success title_index">Có ${listChuyenXe.size()} chuyến xe đăng ký nhận giao hàng</p>
            ...
            <tr>
                <td colspan="3">
                    <div class="infoGiaoHang${cx.id}" style="display: none">
                        ...
                        <div class="spinner-border mySpinnerGiaoHang${cx.id}" style="display: none"></div>
                        <button onclick="handleRegisterGiaoHang(${cx.id}, `${endpointGiaoHang}`)" class="btn btn-success btn_giao_hang${cx.id}">Đăng ký giao hàng</button>
                    </div>
                </td>
                <td colspan="3">
                    <div class="infoGiaoHang${cx.id}" style="display: none">
