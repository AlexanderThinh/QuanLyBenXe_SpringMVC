...
<form>
    ...
    <div class="form-group">
        <label for="benXeId">Bến cho khởi hành</label>
        <select type="text" id="benXeId" name="benXeId" cssClass="form-control" class="select_form">
    ...
    <div class="form-group">
        <div class="spinner-border mySpinnerThemNX" style="display: none"></div>
        <input onclick="themNhaXe(`${endpoint}`)" value="Thêm nhà xe" class="btn btn-success btnThemNX" />
    </div>
</form>
